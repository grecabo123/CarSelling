...
function Sells() {
    ...
    const StatusProduct = (AllData) => {
        return (
            <>
                {
                    AllData.is_dealer_sold === 1 ? <Badge severity={'success'} value={'Sold'} /> : <Badge severity={'danger'}  value={'Not Sold'}/>
                }
            </>
        )
    }
        ...
        <div className='container'>
            ...
            <Card title="Product">
                ...
                <DataTable paginator paginatorLeft value={AllData} rows={8} loading={loading}>
                    ...
                    <Column field='is_dealer_sold' body={StatusProduct} header="Product Status"></Column>
