...
function Sell() {
    ...
    const Actions = (Product) => {
        return (
            <span><Button onClick={GetDetails} data-status={Product.is_customer_sold} className='p-button-sm p-button-info' data-unique={Product.unique_key} label='Details' /></span>
        )
    }
